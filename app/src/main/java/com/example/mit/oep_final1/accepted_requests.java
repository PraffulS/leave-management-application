...
public class accepted_requests extends Fragment implements RecyclerView.OnScrollChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new CardAdapter1(listSuperHeroes, getActivity().getApplicationContext());
